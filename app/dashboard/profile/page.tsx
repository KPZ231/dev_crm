...
export default function ProfilePage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] p-8 text-center animate-in fade-in zoom-in duration-500">
      ...
      <h1 className="text-3xl font-bold text-[#fafafa] tracking-tight mb-4">Twój Profil</h1>
      <p className="text-[#a1a1aa] max-w-md mx-auto leading-relaxed mb-8">
        Moduł profilu użytkownika jest obecnie w przygotowaniu. Wkrótce zyskasz możliwość zmiany awatara, hasła i ustawień powiadomień.
      </p>
      <Link 
        href="/dashboard"
