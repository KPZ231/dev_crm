...
export function TaskListTable({ tasks, workspaceId }: TaskListTableProps) {
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex justify-end gap-2">
                    <button 
                        ...
                        className="p-2 text-[#52525b] hover:text-[#fafafa] bg-[#141416] border border-[#27272a] rounded-lg transition-all"
                    >
